<div id="entrycolumn">
	<div class="entry_inner">
		...
		<form name="form1" id="form1" method="post" action="<!--{$smarty.server.PHP_SELF|escape}-->">
            ...
            <input type="hidden" name="cr" value="<!--{$arrForm.cr}-->" />
			<!--{$add_html}-->
			<div class="entry_info">
				<ul>
                    ...
                    <li class="entry_info_inner02">
                        ...
                        <div>
                            <input type="text" name="email" size="36" value="<!--{$email|escape}-->" style="<!--{$arrErr.email|sfGetErrorColor}-->; ime-mode: disabled;"  autocomplete="off"/>
                        </div>
                    </li>
					...
					<li class="entry_info_inner02">
						...
						<div><input type="password" name="password" value="<!--{$arrForm.password|escape}-->" size="15" class="box380" style="<!--{$arrErr.password|sfGetErrorColor}-->"/></div>
						<p class="mini attention"><!--{$password_rule.message|escape}--></p>
						<div><input type="password" name="password02" value="<!--{$arrForm.password02|escape}-->" size="15" class="box380"  style="<!--{$arrErr.password02|sfGetErrorColor}-->"/></div>
			...
			<ul>
				<li class="sp_btn">
					<a href="javascript:void();" onclick="document.form1.submit();">確認ページへ</a><input type="hidden" name="confirm" id="confirm" />
				</li>
			</ul>
		</form>
	</div>
