...
<ul class="btn_area">
	<li class="prv_btn">
		<a href="<!--{$smarty.server.PHP_SELF|escape}-->" onclick="fnModeSubmit('return', '', ''); return false;">戻る<input type="hidden" name="back" id="back" /></a>
	</li>
	<li class="nx_btn">
		<a href="javascript:void();" onclick="document.form1.submit();">送信<input type="hidden" name="send" id="send" /></a>
	</li>
</ul>
