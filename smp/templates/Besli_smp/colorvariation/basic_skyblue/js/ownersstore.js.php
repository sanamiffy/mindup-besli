<?php
//require_once '/var/www/eccube/dev1/html/require.php';//comment out edited by kitamura 2016/02/03.
//ob_start();
//?>
///*
...
//loading_img.src = '[%URL_DIR%]user_data/packages/pr_default/img/ajax/loading.gif';
//
