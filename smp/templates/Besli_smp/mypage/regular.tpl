			...
			<!--{if $tpl_linemax > 0}-->
				...
				<div class="regular_list">
                        <table summary="定期申込一覧">
                            <tr>
                                <th style="width:20%;" class="centertd">申込日時</th>
                                <th style="width:20%;" class="centertd">申込番号</th>
                                <th style="width:20%;" class="centertd">申込金額</th>
                       ...
                       <table summary="定期申込詳細">
                           <tr>
                                ...
                                <td style="width:20%;" class="pd5"><!--{$arrOrder[cnt].create_date|sfDispDBDate}--></td>
                                <td style="width:20%;" class="centertd pd5">
                                      ...
                                      <div class="listbt_area">
                                          <ul>
                                              <li id="regular_list_<!--{$arrOrder[cnt].order_id}-->" class="syncer-acdn" data-target="regular_detail_<!--{$arrOrder[cnt].order_id}-->" onclick="showRegularDetail('<!--{$arrOrder[cnt].order_id}-->')">
                                              	<div class="mg_dtbtn"><span class="pst10">申込<br />詳細</span></div>
                                              </li>
                                              <li>
                                ...
                                <td colspan="4">
                                   <div class="regular_detail" id="regular_detail_<!--{$arrOrder[cnt].order_id}-->" style="display:none;margin: 10px 0 0 0;">
                                     ...
                                     <h3>定期コース申込詳細&nbsp;&nbsp;<span style="color:#cc0000;" class="regular_stop_status"></span></h3>
                                      <div class="mypage_regstatus">                                          <table>
                                                ...
                                                <tr>
                                                    <th>希望時間指定&nbsp;</th><td><!--{if $arrOrder[cnt].deliv_time}--><!--{$arrOrder[cnt].deliv_time|escape}--><!--{else}-->指定なし<!--{/if}--></td>
                                                 </tr>
                                           </table>
                                         </div>
                                        ...
                                        <!--{section name=pr_cont loop=$arrOrder[cnt].products}-->
                                            ...
                                            <div class="mypage_info_right">
                                                <p><!--{$arrOrder[cnt].products[pr_cont].product_code|escape}--></p>
                                                <p><a href="/smp/product/detail/<!--{$arrOrder[cnt].products[pr_cont].product_id}-->"><!--{$arrOrder[cnt].products[pr_cont].product_name|mb_truncate:35|escape}--></a></p>
                                                <p class="mypage_info_num">数量：<!--{$arrOrder[cnt].products[pr_cont].quantity|number_format}-->個 / 単価：<!--{$arrOrder[cnt].products[pr_cont].price|number_format}-->円</p>
                                        ...
                                        <div class="mypage_regtotal">
                                            <table>
                                                    ...
                                                    <tr>
                                                        <th>ポイント値引き</th>
                                                        <td>
                                                        <!--{$arrOrder[cnt].use_point|number_format}-->Pt</td>
                                                    </tr>
                                                    <!--{/if}-->
                                                    ...
                                                    <tr>
                                                        <th>手数料</th>
                                                        <td>
                                                        <!--{$arrOrder[cnt].charge|number_format}-->円</td>
                                                     </tr>
                                                     <!--{/if}-->
                                                    ...
                                                    <tr>
                                                        <th>離島手数料</th>
                                                        <td>
                                                        <!--{$arrOrder[cnt].relay_fee|number_format}-->円</td>
                                                     </tr>
                                                     <!--{/if}-->
                                                     <tr>
                                                        <th>お支払い合計金額</th>
                                               ...
                                               <tr>    
                                                  <td colspan="2">
                                                      ...
                                                      <div class="pd10" style="overflow:hidden;">
                                                         ...
                                                         <span class="mg_changebt" id="button_cycle_<!--{$arrOrder[cnt].order_id}-->" onclick="changeCycleView_toggle('<!--{$arrOrder[cnt].order_id}-->');">変更する</span>								  </div>
                                                  </td>
                                              </tr>
                                              <tr>    
                                                  <td colspan="2">
  ...
  <div class="mouosikomi_tb2">
      <table summary="サイクルの変更" style="margin:0 auto;padding:0;">
        ...
        <tr id="cycle_date" style="display: none;">
          <td>
            <div id="set_date1">
              <input type="radio" name="cycle_type" id="cycle_type1" value="1" <!--{if $regular_order_master.cycle_type == 1}-->checked="checked"<!--{/if}-->><label for="cycle_type1"><span>日付で指定</span></label>			<div class="cyclebox">
        ...
        <tr id="cycle_week" style="display: none;">
          <td>
            <div id="set_date2">
              <input type="radio" name="cycle_type" id="cycle_type2" value="2" <!--{if $regular_order_master.cycle_type == 2}-->checked="checked"<!--{/if}-->><label for="cycle_type2"><span>曜日で指定</span></label><br /><div class="cyclebox">
