...
<table width="" cellspacing="0" cellpadding="0" summary=" ">
	<tr>
		...
		<!--パンクズ-->
			<div id="pan">
				<span class="fs12n"><a href="<!--{$smarty.const.URL_DIR}-->index.php">トップページ</a>＞<span class="redst">お気に入り商品</span></span>
			</div>
		<!--パンクズ-->
			<table cellspacing="0" cellpadding="0" summary=" " id="container">
				...
				<tr valign="top">
					...
					<td id="right">
						<!--タイトル-->
							<div id="maintitle">
								<img src="<!--{$TPL_DIR}-->img/mypage/title.jpg" width="570" height="40" alt="マイページ" />
							</div>
						<!--タイトル-->
						<!--▼MYページナビ-->
						...
						<!--サブタイトル-->
							<div id="subtitle">
								<img src="<!--{$TPL_DIR}-->img/mypage/subtitle07.gif" width="110" height="16" alt="閲覧履歴" />
							</div>
						<!--サブタイトル-->

						<!--{if $arrForm}-->
							<div id="comment"><span class="fs12">ワンクリックで閲覧商品のページに行く事ができます。<br />
								<span class="asterisk">※</span>最大<!--{$smarty.const.CUSTOMER_READING_MAX}-->件まで表示します。</span>
							</div>
