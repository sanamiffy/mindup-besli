...
<div class="pankuzuarea">
	...
	<ul>
		<li class="mg_newbtn">
			<a href="javascript:void();" onclick="document.form1.submit();">登録する<input type="hidden" name="register" id="register" /></a>
		</li>
	</ul>
