								...
								<p class="pricebox">価格<span class="mini">(税込):</span>
									<span class="price1">
										<!--{if $val.price02_min == $val.price02_max}-->
											<!--{$val.price02_min|reduce_price:$val.product_id:$session_customer_id|sfPreTax:$arrSiteInfo.tax:$arrSiteInfo.tax_rule|number_format}-->
										<!--{else}-->
											<!--{$val.price02_min|reduce_price:$val.product_id:$session_customer_id|sfPreTax:$arrSiteInfo.tax:$arrSiteInfo.tax_rule|number_format}-->～
											<!--{$val.price02_max|reduce_price:$val.product_id:$session_customer_id|sfPreTax:$arrSiteInfo.tax:$arrSiteInfo.tax_rule|number_format}-->
										<!--{/if}-->円
									</span>
								</p>
							</a>
