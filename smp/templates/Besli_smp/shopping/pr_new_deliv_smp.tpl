		...
		<table summary="会員登録フォーム">
			...
			<tr>
				<td>
					...
					<!--{*<div><input type="text" name="order_email" size="40" class="box380" value="<!--{$order_email|escape}-->" style="<!--{$arrErr.order_email|sfGetErrorColor}-->; ime-mode: disabled;" /></div>*}-->
					<!--{if $tpl_use_smp_kara_mail}-->
						<input type="hidden" name="order_email" value="<!--{$order_email|escape}-->" />
						<div><!--{$order_email|escape}--></div>
					<!--{else}-->
						<input type="text" name="order_email" value="<!--{$order_email|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="width:95%;<!--{$arrErr.order_email|sfGetErrorColor}-->; ime-mode: active;"   autocomplete="off"/>&nbsp;
					<!--{/if}-->
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td>
					...
					姓&nbsp;<input type="text" name="order_name01" value="<!--{$order_name01|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="width:100px;<!--{$arrErr.order_name01|sfGetErrorColor}-->; ime-mode: active;"  autocomplete="off"/>&nbsp;
					名&nbsp;<input type="text" name="order_name02" value="<!--{$order_name02|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="width:100px;<!--{$arrErr.order_name02|sfGetErrorColor}-->; ime-mode: active;"  autocomplete="off"/>
				</td>
			</tr>
			<tr>
				<th>お名前<br />(ﾌﾘｶﾞﾅ)<span class="attention">※</span></th>
			</tr>
			<tr>
				<td>
					<span class="attention"><!--{$arrErr.order_kana01}--><!--{$arrErr.order_kana02}--></span>
					ｾｲ&nbsp;<input type="text" name="order_kana01" value="<!--{$order_kana01|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="width:100px;<!--{$arrErr.order_kana01|sfGetErrorColor}-->; ime-mode: active;" autocomplete="off"/>&nbsp;
					ﾒｲ&nbsp;<input type="text" name="order_kana02" value="<!--{$order_kana02|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="width:100px;<!--{$arrErr.order_kana02|sfGetErrorColor}-->; ime-mode: active;" autocomplete="off"/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td>
					...
					〒&nbsp;<input type="text" name="order_zip01" value="<!--{if $order_zip01 == ""}--><!--{$arrOtherDeliv.order_zip01|escape}--><!--{else}--><!--{$order_zip01|escape}--><!--{/if}-->" maxlength="<!--{$smarty.const.order_zip01_LEN}-->" style="width:70px;<!--{$arrErr.order_zip01|sfGetErrorColor}-->; ime-mode: disabled;" class="box60"  autocomplete="off"/>&nbsp;-&nbsp;<input type="text" name="order_zip02" value="<!--{if $order_zip02 == ""}--><!--{$arrOtherDeliv.order_zip02|escape}--><!--{else}--><!--{$order_zip02|escape}--><!--{/if}-->" maxlength="<!--{$smarty.const.order_zip02_LEN}-->" style="width:70px;<!--{$arrErr.order_zip02|sfGetErrorColor}-->; ime-mode: disabled;" class="box60"  autocomplete="off"/>&nbsp;
					<p class="zipimg">
			...
			<tr>
				<td>
					...
					<p>
						<input type="text" name="order_addr01" value="<!--{$order_addr01|escape}-->" style="width:95%;<!--{$arrErr.order_addr01|sfGetErrorColor}-->; ime-mode: active;" autocomplete="off"/><br />
						<!--{$smarty.const.SAMPLE_ADDRESS1}-->
					</p>
					<p>
						<input type="text" name="order_addr02" value="<!--{$order_addr02|escape}-->" style="width:95%;<!--{$arrErr.order_addr02|sfGetErrorColor}-->; ime-mode: active;" class="box380" autocomplete="off"/><br />
			...
			<tr>
				<td>
					...
					<input type="text" name="order_tel01" value="<!--{$order_tel01|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" class="box60" style="width:50px;<!--{$arrErr.order_tel01|sfGetErrorColor}-->; ime-mode: disabled;"  autocomplete="off"/>&nbsp;-&nbsp;<input type="text" name="order_tel02" value="<!--{$order_tel02|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="width:50px;<!--{$arrErr.order_tel02|sfGetErrorColor}-->; ime-mode: disabled;" class="box60"  autocomplete="off"/>&nbsp;-&nbsp;<input type="text" name="order_tel03" value="<!--{$order_tel03|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="width:50px;<!--{$arrErr.order_tel03|sfGetErrorColor}-->; ime-mode: disabled;" class="box60"  autocomplete="off"/>
				</td>
			</tr>
			<tr>
				<th>FAX</th>
			...
			<tr>
				<td>
					...
					<input type="text" name="order_fax01" value="<!--{$order_fax01|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->"  style="width:50px;<!--{$arrErr.order_fax01|sfGetErrorColor}-->; ime-mode: disabled;" class="box60"  autocomplete="off" />&nbsp;-&nbsp;<input type="text" name="order_fax02" value="<!--{$order_fax02|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="width:50px;<!--{$arrErr.order_fax02|sfGetErrorColor}-->; ime-mode: disabled;" class="box60"  autocomplete="off"/>&nbsp;-&nbsp;<input type="text" name="order_fax03" value="<!--{$order_fax03|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="width:50px;<!--{$arrErr.order_fax03|sfGetErrorColor}-->; ime-mode: disabled;" class="box60"  autocomplete="off"/>
				</td>
			</tr>
			<!--{if !$login}-->
				<tr>
			...
			<!--{else}-->
				...
				<tr>
					<td>
						...
						<div>
							<input type="radio" name="mailmaga_flg" id="html" value="1" style="<!--{$arrErr.mailmaga_flg|sfGetErrorColor}-->" <!--{if $mailmaga_flg eq 1 || $mailmaga_flg eq ""}--> checked="checked"<!--{/if}--> />
							<label for="html">HTMLメール＋テキストメールを受け取る</label>
						</div>
						<div>
							<input type="radio" name="mailmaga_flg" id="text" value="2" style="<!--{$arrErr.mailmaga_flg|sfGetErrorColor}-->" <!--{if $mailmaga_flg eq 2}--> checked="checked"<!--{/if}--> />
							<label for="text">テキストメールを受け取る</label>
						</div>
						<div>
