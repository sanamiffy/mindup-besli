			...
			<div class="info_change">
				<ul>
					...
					<li class="info_inner02">
						...
						姓&nbsp;<input class="input_tx" type="text" name="order_name01" size="10" value="<!--{$order_name01|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.order_name01|sfGetErrorColor}-->; ime-mode: active;"   autocomplete="off"/>&nbsp;
						名&nbsp;<input class="input_tx" type="text" name="order_name02" size="10" value="<!--{$order_name02|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.order_name02|sfGetErrorColor}-->; ime-mode: active;"   autocomplete="off"/>
					</li>
					...
					<li class="info_inner02">
						...
						ｾｲ&nbsp;<input class="input_tx" type="text" name="order_kana01" size="8" value="<!--{$order_kana01|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.order_kana01|sfGetErrorColor}-->; ime-mode: active;"  autocomplete="off"/>&nbsp;
						ﾒｲ&nbsp;<input class="input_tx" type="text" name="order_kana02" size="8" value="<!--{$order_kana02|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.order_kana02|sfGetErrorColor}-->; ime-mode: active;"  autocomplete="off"/>
					</li>
					...
					<li class="info_inner02">
						...
						〒&nbsp;<input class="input_tx" type="text" name="order_zip01" value="<!--{if $order_zip01 == ""}--><!--{$arrOtherDeliv.order_zip01|escape}--><!--{else}--><!--{$order_zip01|escape}--><!--{/if}-->" maxlength="<!--{$smarty.const.order_zip01_LEN}-->" style="<!--{$arrErr.order_zip01|sfGetErrorColor}-->; ime-mode: disabled;" size="6"  autocomplete="off"/>&nbsp;-&nbsp;<input class="input_tx" type="text" name="order_zip02" value="<!--{if $order_zip02 == ""}--><!--{$arrOtherDeliv.order_zip02|escape}--><!--{else}--><!--{$order_zip02|escape}--><!--{/if}-->" maxlength="<!--{$smarty.const.order_zip02_LEN}-->" style="<!--{$arrErr.order_zip02|sfGetErrorColor}-->; ime-mode: disabled;" size="6"  autocomplete="off"/>&nbsp;
						<p class="zipimg">
					...
					<li class="info_inner02">
						...
						<p style="margin:5px 0;">
							<input class="input_tx" type="text" name="order_addr01" value="<!--{$order_addr01|escape}-->" style="<!--{$arrErr.order_addr01|sfGetErrorColor}-->; ime-mode: active;"  autocomplete="off"/><br />
							<!--{$smarty.const.SAMPLE_ADDRESS1}-->
						</p>
						<p style="margin:5px 0;">
							<input class="input_tx" type="text" name="order_addr02" value="<!--{$order_addr02|escape}-->" style="<!--{$arrErr.order_addr02|sfGetErrorColor}-->; ime-mode: active;" autocomplete="off"/><br />
					...
					<li class="info_inner02">
							...
							<input class="input_tx" type="text" name="order_tel01" size="6" value="<!--{$order_tel01|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr.order_tel01|sfGetErrorColor}-->; ime-mode: disabled;"  autocomplete="off"/>&nbsp;-&nbsp;<input class="input_tx" type="text" name="order_tel02" size="6" value="<!--{$order_tel02|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr.order_tel02|sfGetErrorColor}-->; ime-mode: disabled;" autocomplete="off"/>&nbsp;-&nbsp;<input class="input_tx" type="text" name="order_tel03" size="6" value="<!--{$order_tel03|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr.order_tel03|sfGetErrorColor}-->; ime-mode: disabled;"  autocomplete="off"/>

					</li>
					<li class="info_head">FAX</li>
					<li class="info_inner02">
						<span class="attention"><!--{$arrErr.order_fax01}--><!--{$arrErr.order_fax02}--><!--{$arrErr.order_fax03}--></span>
						<input class="input_tx" type="text" name="order_fax01" size="6" value="<!--{$order_fax01|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->"  style="<!--{$arrErr.order_fax01|sfGetErrorColor}-->; ime-mode: disabled;" autocomplete="off"/>&nbsp;-&nbsp;<input class="input_tx" type="text" name="order_fax02" size="6" value="<!--{$order_fax02|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr.order_fax02|sfGetErrorColor}-->; ime-mode: disabled;"  autocomplete="off"/>&nbsp;-&nbsp;<input class="input_tx" type="text" name="order_fax03" size="6" value="<!--{$order_fax03|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr.order_fax03|sfGetErrorColor}-->; ime-mode: disabled;" autocomplete="off"/>
					</li>
					<!--{if !$login}-->
