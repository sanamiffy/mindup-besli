		...
		<table summary="会員登録フォーム">
			...
			<tr>
				<td>
					...
					<input type="text" name="order_tel" value="<!--{$order_tel|escape}-->" maxlength="<!--{$smarty.const.TEL_LEN}-->" style="width:150px;<!--{$arrErr.order_tel|sfGetErrorColor}-->;" autocomplete="off" inputmode="numeric"/>
				</td>
			</tr>
			<tr>
				<th>FAX</th>
			...
			<tr>
				<td>
					<span class="attention"><!--{$arrErr.order_fax}--></span>
					<input type="text" name="order_fax" value="<!--{$order_fax|escape}-->" maxlength="<!--{$smarty.const.TEL_LEN}-->"  style="width:150px;<!--{$arrErr.order_fax|sfGetErrorColor}-->;" autocomplete="off" inputmode="numeric" />
				</td>
			</tr>
			<!--{if !$login}-->
				<tr>
