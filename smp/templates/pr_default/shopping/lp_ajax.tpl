...
<div class="bg_pay">
    ...
    <dd class="new_card_info">
        <ul class="smp-lp-username">
            ...
            <li><input type="text" name="<!--{$key1}-->" value="<!--{$arrForm[$key1]|escape}-->" placeholder="TARO"  class="w95" inputmode="text"/></li>
            <li><input type="text" name="<!--{$key2}-->" value="<!--{$arrForm[$key2]|escape}-->" placeholder="YAMADA"  class="w95" inputmode="text"/></li>
        </ul>
        <span class="smp-lp-error"><!--{$arrErr[$key1]}--><!--{$arrErr[$key2]}--></span>
    </dd>
    </div>
