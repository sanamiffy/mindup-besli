<div id="shoppingcolumn">
	...
	<div class="shopping_inner">
		...
		<p>
			...
			入力後、一番下の「同意して送信」ボタンをクリックしてください。
		</p>
			...
			<div class="info_change">
				<ul>
					...
					<li class="info_inner02">
						...
						<input class="input_tx" type="text" name="<!--{$arrForm.$key.keyname}-->" size="18" value="<!--{$arrForm.$key.value|escape}-->" maxlength="<!--{$smarty.const.TEL_LEN}-->" style="<!--{$arrErr.$key|sfGetErrorColor}-->;" inputmode="numeric"/>
					</li>
			...
			<div class="info_change" style="margin-top:20px;">
				...
				<ul>
					...
					<li class="info_inner02">
						...
						<span class="attention" style="color:red;"><!--{$arrErr.$key}--></span>
						<input class="inout_tx" type="text" name="<!--{$arrForm.$key.keyname}-->" value="<!--{$arrForm.$key.value|escape}-->" maxlength="<!--{$arrForm.$key.length}-->" style="<!--{$arrErr.$key|sfGetErrorColor}-->" size="18"/>
					</li>
				</ul>
			</div>
	...
	<div class="privacy_text_box">
		<p class="txt_center">
			...
			<a href="/privacy/index.php" target="_blank">プライバシーポリシー</a><span class="info_agree">に同意する</span>
		</p>
		<p class="info_not_agree" id="error_message_about_non_member_agree" style="display: none;"><em>※同意のチェックがされていません。</em></p>
	</div>
	<ul class="btn_area">
		<li class="nx_btn">
