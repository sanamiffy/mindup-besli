...
<!--{if file_exists("`$smarty.const.FTPROOTPATH`/alternate_html/favicon.svg")}-->
<link rel="icon" href="/img/favicon.svg?<!--{$smarty.const.FRONT_IMG_VERSION|escape}-->" type="image/svg+xml">
<!--{else}-->
<link rel="icon" href="/img/favicon.ico?<!--{$smarty.const.FRONT_IMG_VERSION|escape}-->">
<!--{/if}-->
<link rel="apple-touch-icon" href="/img/apple-touch-icon.png?<!--{$smarty.const.FRONT_IMG_VERSION|escape}-->">
<link rel="icon" type="image/png" href="/img/android-chrome-192x192.png?<!--{$smarty.const.FRONT_IMG_VERSION|escape}-->">
<!--{if $amazon_client_id}-->
