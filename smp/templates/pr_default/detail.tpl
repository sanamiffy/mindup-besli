					...
					<!--{*if $arrProduct.regular != 1*}-->
						...
						<!--{if $tpl_stock_find}-->
							...
							<!--★▼カートに入れる▼★-->
								<ul>
									<li class="sp_btn">
										<a href="javascript:void(0);" onclick="document.form1.submit();" class="js-prevent-form-submit">カートに入れる<input type="hidden" name="cart" id="cart" /></a>
									</li>
								</ul>
							<!--★▲カートに入れる▲★-->
						<!--{else}-->
					...
					<!--{if $arrProduct.regular != 0}-->
						<div class="teiki">
							...
							<form name="form2" id="form2" method="post" action="<!--{$smarty.server.REQUEST_URI|omit_query_part|escape}-->">
								...
								<!--★▼カートに入れる▼★-->
									<div class="sp_btn">
										<a href="javascript:void(0);" onclick="document.form2.submit();" class="js-prevent-form-submit">カートに入れる<input type="hidden" name="cart2" id="cart2" /></a>
									</div>
								<!--★▲カートに入れる▲★-->
								<!--{else}-->
