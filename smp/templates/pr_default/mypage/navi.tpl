...
<div id="mynavarea">
   ...
   <!--{if $tpl_mypageno == 'regular'}-->
    ...
    <!--{if $paygent_credit_flg && $useable_register_card_info_flg && $card_edit_flag_map.paygent}-->
