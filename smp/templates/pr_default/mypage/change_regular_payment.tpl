        ...
        <tr>
            <th colspan="2">
                <input
                    ...
                    id="payment_wallet_<!--{$payment_wallet_id|escape}-->_<!--{$payment_id|escape}-->"
                    value="<!--{$payment_wallet_id|escape}-->"
                />
                <label for="payment_wallet_<!--{$payment_wallet_id|escape}-->_<!--{$payment_id|escape}-->"> このカードを使用する</label> （<!--{$smarty.foreach.wallet.iteration|escape}-->枚目）
            </th>
		</tr>
		<tr>
		    <th style="width:30%;">カード番号</th>
