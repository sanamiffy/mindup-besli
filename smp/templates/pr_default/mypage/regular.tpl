        ...
        <form name="form1" method="post" action="<!--{$smarty.server.PHP_SELF|escape}-->">
            ...
            <!--{if $tpl_linemax > 0}-->
                ...
                <div class="regular_list">
                    ...
                    <table summary="定期申込詳細" class="reg_history<!--{if $arrOrder[cnt].is_pub == 0}--> cancel_tbl<!--{/if}-->">
                        <tr>
                            <td class="histry_cap<!--{if $arrOrder[cnt].is_pub == 0}-->_c<!--{/if}-->" width="22%">商品名</td>
                            <td colspan="4"><!--{$arrOrder[cnt].name|mb_truncate:40|mb_strimwidth:0:100:'...':'UTF-8'|escape}--><!--{if $arrOrder[cnt].is_pub == 0}--><span class="master_cancel">＜停止＞</span><!--{/if}--></td>
                        </tr>
                        <tr>
                            <td class="histry_cap<!--{if $arrOrder[cnt].is_pub == 0}-->_c<!--{/if}-->">申込日時</th>
                            <td colspan="2"><!--{$arrOrder[cnt].create_date|sfDispDBDate}--></td>
                        <tr>
                            <td class="histry_cap<!--{if $arrOrder[cnt].is_pub == 0}-->_c<!--{/if}-->">申込番号</td>
                            <td width="25%">
                                <!--{$arrOrder[cnt].order_id}-->
                            </td>
                            <td class="histry_cap<!--{if $arrOrder[cnt].is_pub == 0}-->_c<!--{/if}-->" width="21%">申込金額</td>
                            <!--{assign var=payment_id value="`$arrOrder[cnt].payment_id`"}-->
                            <!--<td rowspan="2" style="text-align:center"><!--{$arrPayment[$payment_id]|escape}--></td>-->
                            <td><!--{$arrOrder[cnt].next_payment_total|number_format}-->円</td>
                        </tr>
                        <tr>
                          <td colspan="4">次回お届け日：<!--{$arrOrder[cnt].regular_order_master.next_date|date_format:"%Y年%m月%d日"}--></td>
                        </tr>
                        <tr>
                          <td colspan="4">配送サイクル：<!--{$arrOrder[cnt].regular_order_master.cycle_jp|escape}--></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="4">
                                <div id="regular_detail_<!--{$arrOrder[cnt].order_id}-->" style="display:none;margin: 10px 0 0 0;">
                                    <div class="rebular_dtbox">
                                        ...
                                        <div class="mypage_regstatus">
                                            <table>
                                                ...
                                                <tr>
                                                    <th class="in_btn_th">お支払方法&nbsp;</th>
                                                    <td class="in_btn_td"><!--{$arrOrder[cnt].payment_method|escape}-->
                                                        <div class="cdbox_bt">
                                                            <!--▼支払い方法の変更-->
                                                            <span class="mg_changebt" id="button_changepayment_<!--{$arrOrder[cnt].order_id}-->"  onclick="ChangePayment('<!--{$arrOrder[cnt].order_id}-->');" style="display: none;" />変更する</span>
                                                            <!--▼利用カード確認・変更ダイアログボタン-->
                                        ...
                                        <div class="mypage_info_all">
                                            ...
                                            <div class="mypage_info_right">
                                                ...
                                                <p class="mypage_info_num">数量：
                                                    <span id="button_chenge_quantity<!--{$arrOrder[cnt].order_id|escape}-->"><!--{$arrOrder[cnt].products[pr_cont].quantity|number_format|escape}--></span>個
                                                    <!--{if $arrOrder[cnt].products[pr_cont].master_product && !($arrOrder[cnt].products[pr_cont].distribution)}-->
                                                    <span id="button_subscription_quantit_<!--{$arrOrder[cnt].order_id|escape}-->" class="mg_quantity_changebt" onclick="changeQuantityView_toggle('<!--{$arrOrder[cnt].order_id|escape:javascript}-->');">数量を変更する</span>
                                                    <!--{/if}-->
                                                </p>
                                                <p class="mypage_info_num">単価：
                                                <!--{$arrOrder[cnt].next_price[pr_cont]|number_format|escape}-->円</p>
                                            </div>
                                            <!--{/section}-->
                                        ...
                                        <h4 class="subttl4">▼&nbsp;ご注文金額</h4>

                                        <div class="mypage_regtotal">
                                            <table>
                                                <tr>
                                                    <th>お申し込み小計</th>
                                                    <td><!--{$arrOrder[cnt].next_subtotal-$arrOrder[cnt].next_tax_total|number_format}-->円</td>
                                                </tr>
                                                <tr>
                                                    <th>消費税</th>
                                                    <td><!--{$arrOrder[cnt].next_tax_total|number_format}-->円</td>
                                                </tr>
                                                ...
                                                <!--{/if}-->
                                                <!--{if $arrOrder[cnt].next_discount > 0}-->
                                                <tr>
                                                    <th>値引き</th>
                                                    <td><!--{$arrOrder[cnt].next_discount|number_format}-->円</td>
                                                </tr>
                                                <!--{/if}-->
                                                <tr>
                                                    <th>送 料(税込)</th>
                                                    <td><!--{$arrOrder[cnt].next_deliv_fee|number_format}-->円</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <th>お支払い合計金額</th>
                                                    <td><em><!--{$arrOrder[cnt].next_payment_total|number_format}-->円</em></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>
...
<!--{* 定期商品個数変更 *}-->
<div id="change_quantity_dialog" style="display:none" data-size="300">
    <form id="quantity_change">
    <div class="mouosikomi_tb2">
        <table summary="定期商品個数変更">
        <tr><th>ご希望の数量を選択してください</th></tr>
        <tr>
            <td class="lefttd" id="class_quantity_text">
                <select name="class_quantity" id="class_quantity" style="float:none;">
                </select>
            </td>
        </tr>
        </table>
