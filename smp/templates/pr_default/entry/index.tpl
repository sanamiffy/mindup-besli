			...
			<div class="entry_info">
				<ul>
					...
					<li class="entry_info_inner02">
						...
						<input type="text" name="tel" size="<!--{$smarty.const.TEL_LEN}-->" value="<!--{$tel|escape}-->" maxlength="<!--{$smarty.const.TEL_LEN}-->" style="<!--{$arrErr.tel|sfGetErrorColor}-->; " autocomplete="off" inputmode="numeric"/>
					</li>
					<li class="entry_info_head">FAX</li>
					<li class="entry_info_inner02">
						<span class="attention"><!--{$arrErr.fax}--></span>
						<input type="text" name="fax" size="<!--{$smarty.const.TEL_LEN}-->" value="<!--{$fax|escape}-->" maxlength="<!--{$smarty.const.TEL_LEN}-->"  style="<!--{$arrErr.fax|sfGetErrorColor}-->; " autocomplete="off" inputmode="numeric"/>
					</li>
