...
<div id="shoppingcolumn">
  <div id="shopping_inner">
    ...
    <table summary="決済情報の入力">
      ...
      <ul class="btn_area"> 
        <li class="prv_btn">
          <a href="javascript:void();" onclick="fnModeSubmit('return','',''); return false;">前のページへ戻る</a>
          <input type="hidden" name="back03" id="back03" />
        </li>
        <li class="nx_btn">
          <a href="javascript:void();" onclick="fnCheckSubmit('register', '', '');return false;">ご注文完了ページへ</a>
