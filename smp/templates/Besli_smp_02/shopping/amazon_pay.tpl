...
<div id="shoppingcolumn_ap">
    <div class="shopping_inner_ap">
        ...
        <!--{/if}-->
            ...
            <div class="comp_btn btn_next" id="btn_next" style="display: none;"><a href="javascript:void();" onclick="AmazonPaySubmit('form1');">注文を確定する</a></div>
    ...
    <h2 class="result">注文の詳細</h2>
                            ...
                            <span class="pricearea">
                                ...
                                <!--{else}-->
                                    <!--{if $arrProductsClass[cnt].price02 != ""}-->
                                        &yen;&nbsp;<!--{$arrProductsClass[cnt].price02|sfPreTax:$arrInfo.tax:$arrInfo.tax_rule|string_format:"%d"|number_format|escape}-->
                                    <!--{else}-->
                                        &yen;&nbsp;<!--{$arrProductsClass[cnt].price01|sfPreTax:$arrInfo.tax:$arrInfo.tax_rule|string_format:"%d"|number_format|escape}-->
                                    <!--{/if}-->
                                <!--{/if}-->
                            </span>
        ...
        <h2 class="result_ot">ご要望・お問い合わせ</h2>
            ...
            <div class="under-amzbtn-wrap">
                <div class="comp_btn btn_next" style="display: none;"><a href="javascript:void();" onclick="AmazonPaySubmit('form1');">注文を確定する</a></div>
            </div>
