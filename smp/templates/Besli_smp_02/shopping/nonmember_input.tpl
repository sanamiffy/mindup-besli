<div id="shoppingcolumn">
			...
			<div class="info_change">
				<ul>
					...
					<li class="info_inner02">
						...
						姓&nbsp;<input class="input_tx" type="text" name="<!--{$key1}-->" size="10" value="<!--{$arrForm[$key1].value|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.order_name01|sfGetErrorColor}-->; ime-mode: active;"  />&nbsp;
						名&nbsp;<input class="input_tx" type="text" name="<!--{$key2}-->" size="10" value="<!--{$arrForm[$key2].value|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.order_name02|sfGetErrorColor}-->; ime-mode: active;"  />
					...
					<li class="info_inner02">
						...
						ｾｲ&nbsp;<input class="input_tx" type="text" name="<!--{$key1}-->" size="8" value="<!--{$arrForm[$key1].value|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.order_kana01|sfGetErrorColor}-->; ime-mode: active;" />&nbsp;
						ﾒｲ&nbsp;<input class="input_tx" type="text" name="<!--{$key2}-->" size="8" value="<!--{$arrForm[$key2].value|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.order_kana02|sfGetErrorColor}-->; ime-mode: active;" />
					</li>
					...
					<li class="info_inner02">
						...
						<span class="attention" style="color:red;"><!--{$arrErr[$key1]}--><!--{$arrErr[$key2]}--></span>
						〒&nbsp;<input class="input_tx" type="text" name="<!--{$key1}-->" value="<!--{$arrForm[$key1].value|escape}-->" maxlength="<!--{$smarty.const.order_zip01_LEN}-->" style="<!--{$arrErr.order_zip01|sfGetErrorColor}-->; ime-mode: disabled;" size="6"/>&nbsp;-&nbsp;<input class="input_tx" type="text" name="<!--{$key2}-->" value="<!--{$arrForm[$key2].value|escape}-->" maxlength="<!--{$smarty.const.order_zip02_LEN}-->" style="<!--{$arrErr.order_zip02|sfGetErrorColor}-->; ime-mode: disabled;" size="6"/>&nbsp;
						<p class="zipimg">
					...
					<li class="info_inner02">
						...
						<p style="margin:5px 0;">
							...
							<input class="input_tx" type="text" name="<!--{$key}-->" value="<!--{$arrForm[$key].value|escape}-->" style="<!--{$arrErr.order_addr01|sfGetErrorColor}-->; ime-mode: active;" /><br />
							<!--{$smarty.const.SAMPLE_ADDRESS1}-->
						</p>
						<p style="margin:5px 0;">
							<!--{assign var=key value="order_addr02"}-->
							<input class="input_tx" type="text" name="<!--{$key}-->" value="<!--{$arrForm[$key].value|escape}-->" style="<!--{$arrErr.order_addr02|sfGetErrorColor}-->; ime-mode: active;"/><br />
					...
					<li class="info_inner02">
						...
						<input class="input_tx" type="text" name="<!--{$arrForm[$key1].keyname}-->" size="6" value="<!--{$arrForm[$key1].value|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr.order_tel01|sfGetErrorColor}-->; ime-mode: disabled;" />&nbsp;-
						<input class="input_tx" type="text" name="<!--{$arrForm[$key2].keyname}-->" size="6" value="<!--{$arrForm[$key2].value|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr.order_tel02|sfGetErrorColor}-->; ime-mode: disabled;"/>&nbsp;-
						<input class="input_tx" type="text" name="<!--{$arrForm[$key3].keyname}-->" size="6" value="<!--{$arrForm[$key3].value|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr.order_tel03|sfGetErrorColor}-->; ime-mode: disabled;"/>
					</li>
					...
					<li class="info_inner02">
						...
						<input class="input_tx" type="text" name="order_fax01" size="6" value="<!--{$order_fax01|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->"  style="<!--{$arrErr.order_fax01|sfGetErrorColor}-->; ime-mode: disabled;"/>&nbsp;-&nbsp;<input class="input_tx" type="text" name="order_fax02" size="6" value="<!--{$order_fax02|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr.order_fax02|sfGetErrorColor}-->; ime-mode: disabled;"/>&nbsp;-&nbsp;<input class="input_tx" type="text" name="order_fax03" size="6" value="<!--{$order_fax03|escape}-->" maxlength="<!--{$smarty.const.TEL_ITEM_LEN}-->" style="<!--{$arrErr.order_fax03|sfGetErrorColor}-->; ime-mode: disabled;"/>
					</li>
					...
					<li class="info_inner02">
						...
						<input class="inout_tx" type="text" name="<!--{$arrForm[$key].keyname}-->" value="<!--{$arrForm[$key].value|escape}-->" maxlength="<!--{$arrForm[$key].length}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" size="40"/><br />
						<br />
				...
				<ul>
					...
					<li class="info_inner02">
						...
						<p style="margin:5px 0;">
							...
							<input class="input_tx" type="text" name="<!--{$key}-->" value="<!--{$arrForm[$key].value|escape}-->" style="<!--{$arrErr.deliv_addr01|sfGetErrorColor}-->; ime-mode: active;" /><br />
							<!--{$smarty.const.SAMPLE_ADDRESS1}-->
						</p>
						<p style="margin:5px 0;">
							<!--{assign var=key value="deliv_addr02"}-->
							<input class="input_tx" type="text" name="<!--{$key}-->" value="<!--{$arrForm[$key].value|escape}-->" style="<!--{$arrErr.deliv_addr02|sfGetErrorColor}-->; ime-mode: active;"/><br />
							<!--{$smarty.const.SAMPLE_ADDRESS2}-->
						</p>
						<p style="margin:5px 0;"><em>住所は2つに分けてご記入いただけます。マンション名は必ず記入してください。</em></p>
					</li>
	...
	<ul class="btn_area">
		<li class="nx_btn">
			<a href="javascript:void();" onclick="document.form1.submit();">次へ<input type="hidden" name="next" id="next" /></a>
		</li>
	</ul>
</div>