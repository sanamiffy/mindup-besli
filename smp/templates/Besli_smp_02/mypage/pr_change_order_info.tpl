...
<div id="mypagecolumn">
			...
			<div class="mg_change">
				<dl>
					...
					<dd>
						...
						<input type="text" class="boxHarf text h30" placeholder="姓" name="<!--{$key1}-->" value="<!--{$arrForm.$key1}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.$key1|sfGetErrorColor}-->; ime-mode: active;" />&nbsp;
						<input type="text" class="boxHarf text h30" placeholder="名" name="<!--{$key2}-->" value="<!--{$arrForm.$key2}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.$key2|sfGetErrorColor}-->; ime-mode: active;" />
					...
					<dd>
						...
						<input type="text" class="boxHarf text h30" placeholder="セイ" name="<!--{$key1}-->" value="<!--{$arrForm.$key1}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.$key1|sfGetErrorColor}-->; ime-mode: active;" />&nbsp;
						<input type="text" class="boxHarf text h30" placeholder="メイ" name="<!--{$key2}-->" value="<!--{$arrForm.$key2}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.$key2|sfGetErrorColor}-->; ime-mode: active;" />
						<div class="mg_attention"><!--{$arrErr.$key1}--><!--{$arrErr.$key2}--></div>
					</dd>
                    ...
                    <dd>
                        ...
                        〒&nbsp;
                        <input type="text" class="boxHarf text h30" placeholder="1234567" name="deliv_zip" value="<!--{$arrForm.$key1}--><!--{$arrForm.$key2}-->" maxlength="<!--{$smarty.const.ZIP01_LEN+$smarty.const.ZIP02_LEN}-->" style="<!--{$arrErr[$key3]|sfGetErrorColor}-->; ime-mode: disabled;" size="10"  />&nbsp;
                        <span class="zipimg">
					...
					<dd>
                        ...
                        <div class="mini_add">
                        	...
                        	<p><input type="text" class="boxLong top text h30" placeholder="<!--{$smarty.const.SAMPLE_ADDRESS1}-->" name="<!--{$key1}-->" value="<!--{$arrForm.$key1}-->" size="60" style="<!--{$arrErr.$key1|sfGetErrorColor}-->; ime-mode: active;" /></p>
						</div>
                        <div class="mini_add">
                            <p><!--{$smarty.const.SAMPLE_ADDRESS2}--></p>
                            <p>
                                <input type="text" class="boxLong top text h30" placeholder="<!--{$smarty.const.SAMPLE_ADDRESS2}-->" name="<!--{$key2}-->" value="<!--{$arrForm.$key2}-->" size="60" style="<!--{$arrErr.$key2|sfGetErrorColor}-->; ime-mode: active;" />
                            </p>
                        </div>
	...
	<ul>
		<li class="mg_newbtn">
			<a href="javascript:void();" onclick="document.form1.submit();">確認ページへ</a>
		</li>
	</ul>
