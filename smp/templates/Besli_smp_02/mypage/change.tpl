		...
		<form name="form1" id="form1" method="post" action="<!--{$smarty.server.PHP_SELF|escape}-->">
			...
			<div class="mg_change">
				<h4 class="ttl">お客様の基本情報</h4>
					...
					<dd>
						<input type="text" class="boxHarf text h30" placeholder="姓" name="name01" value="<!--{$arrForm.name01|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.name01|sfGetErrorColor}-->; ime-mode: active;" />&nbsp;
						<input type="text" class="boxHarf text h30" placeholder="名" name="name02" value="<!--{$arrForm.name02|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.name02|sfGetErrorColor}-->; ime-mode: active;" />
						<div class="mg_attention"><!--{$arrErr.name01}--><!--{$arrErr.name02}--></div>
					</dd>
					<dt>お名前（ﾌﾘｶﾞﾅ）<span class="required">必須</span></dt>
					<dd>
						<input type="text" class="boxHarf text h30" placeholder="セイ" name="kana01" value="<!--{$arrForm.kana01|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.kana01|sfGetErrorColor}-->; ime-mode: active;" size="15"  />&nbsp;
						<input type="text" class="boxHarf text h30" placeholder="メイ" name="kana02" value="<!--{$arrForm.kana02|escape}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" style="<!--{$arrErr.kana02|sfGetErrorColor}-->; ime-mode: active;" size="15" />
						<div class="mg_attention"><!--{$arrErr.kana01}--><!--{$arrErr.kana02}--></div>
					</dd>
					<dt>郵便番号<span class="required">必須</span></dt>
					<dd>
												<input type="text" class="boxHarf top text h30" placeholder="1234567" name="zip" value="<!--{$arrForm.zip|escape}-->" maxlength="<!--{$smarty.const.ZIP01_LEN+$smarty.const.ZIP02_LEN}-->" size="30" style="<!--{$arrErr.zip|sfGetErrorColor}-->;ime-mode: disabled;"  />
												<span class="zipimg">
					...
					<dd>
											<div class="custom-selectbox w40">
												...
												<div class="mini_add">
														...
														<input type="text" class="boxLong top text h30" name="addr01" value="<!--{$arrForm.addr01|escape}-->" size="60"style="<!--{$arrErr.addr01|sfGetErrorColor}-->; ime-mode: active;" placeholder="<!--{$smarty.const.SAMPLE_ADDRESS1}-->" /><br />
												</div>
												<div class="mini_add">
														<p><!--{$smarty.const.SAMPLE_ADDRESS2}--></p>
																<input type="text" class="boxLong top text h30" name="addr02" value="<!--{$arrForm.addr02|escape}-->" size="60"style="<!--{$arrErr.addr02|sfGetErrorColor}-->; ime-mode: active;" placeholder="<!--{$smarty.const.SAMPLE_ADDRESS2}-->"/><br />
												</div>
					...
					<dd>
						<input type="text" class="boxLong top text h30" placeholder="09012345678" name="tel" value="<!--{$arrForm.tel|escape}-->" maxlength="<!--{$smarty.const.TEL_LEN}-->" size="30" style="<!--{$arrErr.tel|sfGetErrorColor}-->;ime-mode: disabled;"  />
						<div class="mg_attention"><!--{$arrErr.tel}--></div>
					</dd>
					<dt>FAX<span class="any">任意</span></dt>
					<dd>
						<input type="text" class="boxLong top text h30" placeholder="0312345678" name="fax" value="<!--{$arrForm.fax|escape}-->" maxlength="<!--{$smarty.const.TEL_LEN}-->" size="30" style="<!--{$arrErr.fax|sfGetErrorColor}-->; ime-mode: disabled;"  />
										...
										<ul>
												<li>
													<p class="mini3">メールアドレス<span class="required">必須</span></p>
														<input type="text" class="boxLong text h30" placeholder="sample@example.com" name="email" value="<!--{$arrForm.email|escape}-->" style="<!--{$arrErr.email|sfGetErrorColor}-->; ime-mode: disabled;" maxlength="<!--{$smarty.const.MTEXT_LEN}-->" size="40"/>
														<div class="mg_attention"><!--{$arrErr.email}--></div>
												</li>
												<li>
													<p class="mini3">携帯メールアドレス</p>
														<input type="text" class="boxLong text h30" placeholder="sample@example.com" name="email_mobile" value="<!--{$arrForm.email_mobile|escape}-->" style="<!--{$arrErr.email_mobile|sfGetErrorColor}-->; ime-mode: disabled;" maxlength="<!--{$smarty.const.MTEXT_LEN}-->" size="40"/><div class="mg_attention"><!--{$arrErr.email_mobile}--></div>
												</li>
										 </ul>
								 </dd>
