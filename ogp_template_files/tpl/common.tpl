...
<meta property="og:url" content="<!--{$canonical_url_for_view}-->" />
<!--{else}-->
<meta property="og:url" content="<!--{$smarty.const.SITE_URL}-->" />
<!--{/if}-->
<meta property="og:image" content="<!--{$arrPageLayout.ogp_img_http_url}-->" />
<!--{if $arrPageLayout.ogp_img_https_url|strlen >= 1}-->
<meta property="og:image:secure_url" content="<!--{$arrPageLayout.ogp_img_https_url}-->" />
<!--{/if}-->
