...
<div class="some-wrapper">
        ...
        <img class="mindup_img_1" src="../../gold/img/mindup/others/last_pdt_img.jpg">
        <!--<ul class="m_0">
        ...
        <div class="wrapper_2">
                        <ul>
                        <li class="pt_40"><img class="single" src="../../gold/img/mindup/others/last_pdt_img.jpg"></li>
                        <li class="li-l">
...
<ul>
<!--<li>会社概要</li>-->
<li><a href="/smp/order/index.php" target="_blank">特定商取引法の表記</a></li>
