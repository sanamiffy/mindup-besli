		...
		<div class="mouosikomi_tb2">
			<table summary="購入商品詳細">
				...
				<tr>
					...
					<td width="45%">
                        <a href="/product/detail/<!--{$arrDisp.product_id[cnt]}-->"><!--{$arrDisp.product_name[cnt]|mb_truncate:40|escape}--></a>
                        <!--{* 規格がある場合 *}-->
                        <!--{if $arrDisp.classcategory_name1[cnt] != ''}-->
                        &nbsp;(<!--{$arrDisp.classcategory_name1[cnt]|escape}--></span><!--{if $arrDisp.classcategory_name2[cnt] != ''}-->・<!--{$arrDisp.classcategory_name2[cnt]|escape}--><!--{/if}-->)<!--{/if}-->
                        <!--{* ↑規格表示ここまで *}-->
                    </td>
