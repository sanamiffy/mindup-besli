      ...
      <table summary="会員登録フォーム">
        ...
        <tr>
          ...
          <td>
            ...
            <input type="text" name="tel" value="<!--{$tel|escape}-->" maxlength="<!--{$smarty.const.TEL_LEN}-->" class="box380 entrypt" style="<!--{$arrErr.tel|sfGetErrorColor}-->; ime-mode: disabled;" />
          </td>
        </tr>
        <tr>
          <th>FAX</th>
          <th><span class="any">任意</span></th>
          <td><span class="attention"><!--{$arrErr.fax}--></span>
            <input type="text" name="fax" value="<!--{$fax|escape}-->" maxlength="<!--{$smarty.const.TEL_LEN}-->" class="box380 entrypt" style="<!--{$arrErr.fax|sfGetErrorColor}-->; ime-mode: disabled;" />
          </td>
        </tr>
        <tr>
          <th>メールアドレス</th>
...
<!--{captcha_form_signup}-->
     ...
     <ul class="btn_area_n2">
        <li class="btn_rpst1e">
         ...
         <li class="btn_rpst2e">
			<span class="btn_next">
				<input type="submit" id="n_b_entrycomp" name="n_b_entrycomp" value="同意して送信" onclick="if(!window.confirm('ご入力された内容で登録します。登録しても宜しいですか。')){return false;}fnModeSubmit('complete','','');">
			</span>
        </li>
     </ul>
    </form>
