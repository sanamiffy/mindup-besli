...
<!--{/if}-->
<!--{/foreach}-->
送　料(税込) ￥ <!--{$arrOrder.deliv_fee|number_format|default:0}-->
...
<!--{/foreach}-->
<!--{/if}-->
手数料(税込) ￥ <!--{$arrOrder.charge|number_format|default:0}-->
<!--{if $arrOrder.relay_fee != 0}-->離島手数料(税込) ￥ <!--{$arrOrder.relay_fee|number_format|default:0}--><!--{/if}-->
...
<!--{if $arrInfo.invoice_registration_number != null}-->
<!--{if $arrInfo.company_name != null}-->
<!--{$arrInfo.company_name}-->
<!--{/if}-->
登録番号:<!--{$arrInfo.invoice_registration_number}-->
<!--{/if}-->
<!--{$tpl_footer}-->
