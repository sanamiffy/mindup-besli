        ...
        <table summary="決済情報の入力">
            ...
            <tr class="new_card_info">
                ...
                <td>
                    ...
                    <span class="attention"><!--{$arrErr[$key2]}--></span>
                    <p class="mini">
                        名&nbsp;<input type="text" name="<!--{$key1}-->" value="<!--{$arrForm[$key1]|escape}-->" size="20" class="box120 payinput" placeholder="TARO" inputmode="text"/>&nbsp;&nbsp;
                        姓&nbsp;<input type="text" name="<!--{$key2}-->" value="<!--{$arrForm[$key2]|escape}-->" class="box120 payinput" size="20" placeholder="YAMADA" inputmode="text"/>
                    </p>
                ...
                <table summary="決済情報の入力">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="mini">
                                名&nbsp;<input type="text" name="<!--{$key1}-->" value="<!--{$arrForm[$key1]|escape}-->" size="20" class="box120 payinput" placeholder="TARO" inputmode="text"/>&nbsp;&nbsp;
                                姓&nbsp;<input type="text" name="<!--{$key2}-->" value="<!--{$arrForm[$key2]|escape}-->" size="20" class="box120 payinput" placeholder="YAMADA" inputmode="text"/></p>
                              <p class="pdt10">半角入力(例：TARO&nbsp;YAMADA)</p>
                        </td>
                    </tr>
                    <tr>
