                    ...
                    <!--{*if $arrProduct.regular != 1*}--><!--{*START 定期カゴ非表示タグ*}-->
                        ...
                        <!--{if $tpl_stock_find}-->
                            ...
                            <div class="bd_area" style="clear:both;">
                                ...
                                <div class="cartbtn">
                                    <a href="<!--{if $arrProduct.product_class_disp_setting == 1}-->javascript:void(chooseMatrix(false));<!--{/if}-->javascript:void(document.form1.submit())" class="js-prevent-form-submit">カゴに入れる<input type="hidden" name="cart" id="cart" /></a>
                                </div>
                             </div>
                            <!--{else}-->
                ...
                <div class="teiki_area">
                    ...
                    <form name="form2" id="form2" method="post" action="<!--{$smarty.server.REQUEST_URI|omit_query_part|escape}-->">
                         ...
                         <h3>
                            ...
                            <span class="tx_teiki_en">価格:
                                <span class="price">
                                    <!--{if count($arrProduct.regular_range_price) > 1}-->
                                    <!--{$arrProduct.regular_range_price.0|number_format}-->～<!--{$arrProduct.regular_range_price.1|number_format}-->
                                    <!--{else}-->
                                    <!--{$arrProduct.rg_fprice|number_format}-->
                                    <!--{/if}-->
                                    円
                                </span><span class="mini">(税込)</span></span>
                         </h3>
                        <!--{if $arrProduct.product_class_disp_setting != 1 && $tpl_classcat_find1}-->
                        <dl>
                            <dt><!--{$tpl_class_name1|escape}--></dt>
                        ...
                        <div class="<!--{$cart_btn_class}-->">
                            <!--{if $tpl_stock_find}-->
                                ...
                                <div class="t_cartbtn">
                                    <a href="<!--{if $arrProduct.product_class_disp_setting == 1}-->javascript:void(chooseMatrix(true));<!--{/if}-->javascript:void(document.form2.submit())" class="js-prevent-form-submit">定期購入する<input type="hidden" name="cart2" id="cart2" /></a>
                                </div>
                            <!--{else}-->
                                <div class="attention">申し訳ございませんが、只今品切れ中です。</div>
                            <!--{/if}-->
