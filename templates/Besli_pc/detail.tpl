        ...
        <div class="bd_area">
            ...
            <!--▼ 通常購入エリア ▼-->
                <form name="form1" id="form1" method="post" action="<!--{$smarty.server.REQUEST_URI|omit_query_part|escape}-->">
                    ...
                    <!--{* 定期購入設定中の商品で「カゴに入れる」ボタンを非表示にする場合は定期カゴ非表示タグのSTART、ENDのif文を有効にする *}-->
                            ...
                            <div class="whoboughtleft">
                                ...
                                <p><span class="price">
                                    <!--{if $price02_min == $price02_max}-->
                                        <!--{$price02_min|reduce_price:$arrRecommend[cnt].product_id:$session_customer_id|sfPreTax:$arrSiteInfo.tax:$arrSiteInfo.tax_rule|number_format}-->
                                    <!--{else}-->
                                        <!--{$price02_min|reduce_price:$arrRecommend[cnt].product_id:$session_customer_id|sfPreTax:$arrSiteInfo.tax:$arrSiteInfo.tax_rule|number_format}-->&nbsp;～&nbsp;<!--{$price02_max|reduce_price:$arrRecommend[cnt].product_id:$session_customer_id|sfPreTax:$arrSiteInfo.tax:$arrSiteInfo.tax_rule|number_format}-->
                                    <!--{/if}-->円</span><br /><span class="mini">(税込)</span>
                                </p>
                                <p class="mini"><!--{$arrRecommend[cnt].comment|escape|nl2br}--></p>
                            </div>
