    ...
    <table summary="特定商取引に関する法律に基づく表記">
      ...
      <tr>
        ...
        <td><!--{$arrRet.law_term03|escape|nl2br}--></td>
            ...
            <tr>
      <th>NP後払い決済に関して</th>
      <td>○このお支払方法の詳細 商品の到着を確認してから、「コンビニ」「郵便局」「銀行」で 後払いできる安心・簡単な決済方法です。請求書は、商品とは別に 郵送されますので、発行から14日以内にお支払いをお願いします。<br>
      ○ご注意 後払い手数料：無料 後払いのご注文には、株式会社ネットプロテクションズの提供する NP後払いサービスが適用され、サービスの範囲内で個人情報を提供し、 代金債権を譲渡します。ご利用限度額は累計残高で54,000円（税込）迄です。ご利用者が未成年の場合、法定代理人の利用同意を得てご利用ください。<br/>
<a href="http://np-atobarai.jp/about/" target="_blank"><img src="/gold/img/add/pay_later.png" ></a>
</td>
</tr>
