...
<a href="<!--{$tpl_previous_page|escape}-->&transactionid=<!--{$smarty.get.transactionid}-->">前へ</a>
<!--{/if}-->
<!--{if isset($tpl_previous_page|smarty:nodefaults) && isset($tpl_next_page|smarty:nodefaults)}-->
｜
<!--{/if}-->
<!--{if isset($tpl_next_page|smarty:nodefaults)}-->
<a href="<!--{$tpl_next_page|escape}-->&transactionid=<!--{$smarty.get.transactionid}-->">次へ</a>
<!--{/if}-->
<br><br>
<!--{/if}-->
...
<div align="right">
<!--{if $i+1<9}-->
<a href="<!--{$smarty.const.MOBILE_DETAIL_P_HTML}--><!--{$arrProduct.product_id}-->&transactionid=<!--{$smarty.get.transactionid}-->" accesskey="<!--{$i+1}-->">商品詳細へ→</a>
<!--{else}-->
<a href="<!--{$smarty.const.MOBILE_DETAIL_P_HTML}--><!--{$arrProduct.product_id}-->&transactionid=<!--{$smarty.get.transactionid}-->">商品詳細へ→</a>
<!--{/if}-->
</div>
