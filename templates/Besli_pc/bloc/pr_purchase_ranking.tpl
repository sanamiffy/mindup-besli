<div id="ranking_all">
	...
	<div class="rankarea">
		...
		<div class="rankrightblock">
			<h3><a href="<!--{$smarty.const.DETAIL_P_HTML}--><!--{$rankingData[cnt].product_id}-->"><!--{$rankingData[cnt].name|truncate:40|escape}--></a></h3>
			<p>
				<span class="price">
					<!--{if $rankingData[cnt].price02min == $rankingData[cnt].price02max}-->
					<!--{$rankingData[cnt].price02min|reduce_price:$rankingData[cnt].product_id:$session_customer_id|sfPreTax:$arrSiteInfo.tax:$arrSiteInfo.tax_rule|number_format}-->
					<!--{else}-->
					<!--{$rankingData[cnt].price02min|reduce_price:$rankingData[cnt].product_id:$session_customer_id|sfPreTax:$arrSiteInfo.tax:$arrSiteInfo.tax_rule|number_format}-->～
					<!--{$rankingData[cnt].price02max|reduce_price:$rankingData[cnt].product_id:$session_customer_id|sfPreTax:$arrSiteInfo.tax:$arrSiteInfo.tax_rule|number_format}-->
					<!--{/if}-->円
				</span>
