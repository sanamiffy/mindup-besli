...
<div id="searcharea">
  ...
  <!--検索フォーム-->
    <form name="search_form" id="search_form" method="get" action="<!--{$smarty.const.URL_DIR}-->products/list.php">
        ...
        <p><img src="<!--{$TPL_DIR}-->img/icon/icon_sh.png" alt="商品カテゴリから選ぶ" title="商品カテゴリから選ぶ" />商品カテゴリから選ぶ"</p>
      ...
      <p><img src="<!--{$TPL_DIR}-->img/icon/icon_sh.png" alt="商品名を入力" title="商品名を入力" />商品名を入力</p>
      <p><input type="text" name="name" class="box142" maxlength="50" value="<!--{$smarty.get.name|escape}-->" /></p>
      
      <p><img src="<!--{$TPL_DIR}-->img/icon/icon_sh.png" alt="価格を入力" title="価格を入力" />価格を入力</p>
