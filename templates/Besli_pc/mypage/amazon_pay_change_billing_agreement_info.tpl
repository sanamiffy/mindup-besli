...
<!--{* 支払widget *}-->
        ...
        <ul class="btn_area_l2" id="regist_btn" style="display:none;">
            <li class="btn">
                <span class="btn_next"><a href="javascript:void();" onclick="updateAmazonPayInfo();">変更する</a></span>
            </li>
        </ul>

        <div class="btn_rpst3_2">
                <span class="btn_mgprev"><a href="javascript:void();" onclick="returnAmazonPayInfo();">一覧へ戻る</a></span>
        </div>
  </div>
</div>
