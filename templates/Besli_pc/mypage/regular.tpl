...
<div id="mypagecolumn">
  ...
  <!--{/if}-->
   ...
   <div class="reglar_list">
       <table summary="申込履歴" style="margin-bottom:10px;">
          <tr> 
            <th width="20%" class="centertd">申込日時</th>
            <th width="20%" class="centertd">申込番号</th>
      ...
      <!--{section name=cnt loop=$arrOrder}-->
        <table summary="お申し込み詳細">	
            <tr>
                   <td width="20%"><!--{$arrOrder[cnt].create_date|sfDispDBDate}--></td>
                   ...
                   <td  width="20%" class="centertd"><!--{$arrOrder[cnt].payment_method|escape}--></td>
                    ...
                    <div class="appli_dt">
                        ...
                        <div class="mouosikomi_tb">
                            <table>
                                ...
                                <tr><td>希望時間指定&nbsp;</td><td><!--{if $arrOrder[cnt].deliv_time}--><!--{$arrOrder[cnt].deliv_time|escape}--><!--{else}-->指定なし<!--{/if}--></td>
                                 </tr>  
                              </table>
                    	 </div>
                                ...
                                <tbody>
                                    <tr>
                                      ...
                                      <!--{section name=pr_cont loop=$arrOrder[cnt].products}-->
                                        <tr>
                                          <td  width="20%"><!--{$arrOrder[cnt].products[pr_cont].product_code|mb_truncate:25|escape}--></td>
                                          <td  width="30%"><a href="/product/detail/<!--{$arrOrder[cnt].products[pr_cont].product_id}-->"><!--{$arrOrder[cnt].products[pr_cont].product_name|mb_truncate:25|escape}--></a></td>
