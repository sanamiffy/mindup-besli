...
<span style="color:#C00;">※定期コースをお申込されている方は、定期コースを解約後に解約手続きを行って下さい。</span>
                    </p>

					<ul class="mg_btnarea">
						<li class="mg_newbtn">
								<a href="javascript:void();" onclick="document.form1.submit();">退会する<input type="hidden" name="refusal" id="refusal" /></a>
						</li>
					</ul>
				<!--{else}-->
					定期購入契約中のため、退会できません。
