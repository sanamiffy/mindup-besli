    ...
    <tr>
        ...
        <table cellspacing="0" cellpadding="0" summary=" " id="container">
            ...
            <tr valign="top">
                ...
                <td id="right">
                <!--タイトル-->
                <div id="maintitle"><img src="<!--{$TPL_DIR}-->img/mypage/title.jpg" alt="マイページ" title="マイページ" /></div>
                <!--タイトル-->
                <!--▼MYページナビ-->
                <!--{include file=$tpl_navi}-->
                <!--▲MYページナビ-->
                <!--サブタイトル-->
                <div id="subtitle"><img src="<!--{$TPL_DIR}-->img/mypage/subtitle07.gif" alt="閲覧履歴" title="閲覧履歴" /></div>
                <!--サブタイトル-->
