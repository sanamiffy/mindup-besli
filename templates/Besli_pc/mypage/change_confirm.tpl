		...
		<form name="form1" id="form1" method="post" action="<!--{$smarty.server.PHP_SELF|escape}-->">
            ...
            <div class="mg_change">
                ...
                <div class="btn_rpst3_2">
                    <span class="btn_mgprev"><a href="<!--{$smarty.server.PHP_SELF|escape}-->">前のページへ<input type="hidden" name="back" id="back" /></a></span>
                </div>
                <ul class="btn_area_n2">
                    <li class="btn">
                        <span class="btn_next"><a href="javascript:void();" onclick="document.form1.submit();">送 信<input type="hidden" name="complete" id="complete" /></a></span>
                    </li>
                </ul>
            </div>
		</form>
