...
<div id="shoppingcolumn">
	...
	<div style="clear:both;"> </div>
       <div class="t_daybox ">
                 ...
                 <a href="javascript:void();" onclick="$('#form1').append('<input type=\'hidden\' id=\'confirm\' name=\'confirm\' value=\'1\'/>');document.form1.submit();" class="btn_day" >         
                  <span>お届け日の確認</span>
                  </a>
       </div>
...
<!--Start Button Page Movie-->	
		...
		<div class="btn_rpst2">
			<span class="btn_next">
				<a href="javascript:void();" onclick="document.form1.submit();">選択したお届け先に送る</a>
			</span>
		</div>
