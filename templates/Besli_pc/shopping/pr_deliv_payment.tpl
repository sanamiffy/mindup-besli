  ...
  <form name="form1" id="form1" method="post" action="<!--{$smarty.server.PHP_SELF|escape}-->">
	...
	<div class="payarea">
		...
		<table summary="お支払方法選択">
			...
			<tr>
				<td class="centertd">
					<input type="radio" id="pay_<!--{$smarty.section.cnt.iteration}-->" name="<!--{$key}-->" onclick="fnModeSubmit('payment', '', '');return;" value="<!--{$arrPayment[cnt].payment_id}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" <!--{$arrPayment[cnt].payment_id|sfGetChecked:$arrForm[$key].value}--> />
				</td>
				<td width="500px">
	...
	<!--▲その他問い合わせ-->
        ...
        <div class="tblareabtn">
				...
				<div class="btn_rpst2">
					<span class="btn_next"><a href="javascript:void();" onclick="document.form1.submit();">次のページへ</a></span>
				</div>
        </div>        
