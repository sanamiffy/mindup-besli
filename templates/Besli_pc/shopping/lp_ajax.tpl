    ...
    <tr class="<!--{if $arrPayment[cnt].payment_normal == true}-->payment_normal <!--{/if}--><!--{if $arrPayment[cnt].payment_reg == true}-->payment_reg <!--{/if}--><!--{if $arrPayment[cnt].payment_deliv == true}-->payment_deliv<!--{/if}-->">
    	<td>
            <div style="padding-left:10px;">
                ...
                <br />
                <em<!--{if $arrPayment[cnt].payment_reg == true}--> class="payment_reg"<!--{/if}-->>
                    <!--{if $arrPayment[cnt].payment_affairs_regular || $arrPayment[cnt].payment_affairs}-->
                        <p style="padding-top:20px;"><!--{$arrPayment[cnt].payment_affairs_regular|escape|nl2br}-->
                        <!--{if $arrPayment[cnt].memo03 != '###' || ($arrPayment[cnt].memo03 == '###' && !$arrPayment[cnt].payment_reg)}--><!--{$arrPayment[cnt].payment_affairs|escape|nl2br}--><!--{/if}-->
                        <!--{if $arrPayment[cnt].memo01 == 10 || $arrPayment[cnt].memo01 == 11 }--><!--{$arrPayment[cnt].payment_affairs|escape|nl2br}--><!--{/if}-->
                        </p><!--{/if}-->
                </em><!--{* 定期購入クレジット *}-->
                <em<!--{if $arrPayment[cnt].payment_normal == true}--> class="payment_normal"<!--{/if}-->><!--{if $arrPayment[cnt].payment_affairs && $arrPayment[cnt].payment_reg == true}--><p style="padding-top:10px;"><!--{$arrPayment[cnt].payment_affairs|escape|nl2br}--></p><!--{/if}--></em>
            </div>
        </td>
        <!--{if $img_exist_flg}-->
        ...
        <table summary="決済情報の入力">
            ...
            <tr class="new_card_info">
                ...
                <td>
                    ...
                    <span class="attention"><!--{$arrErr[$key2]}--></span>
                    <p class="mini">
                        名&nbsp;<input type="text" name="<!--{$key1}-->" value="<!--{$arrForm[$key1]|escape}-->" size="20" class="box120 payinput" placeholder="TARO" />&nbsp;&nbsp;
                        姓&nbsp;<input type="text" name="<!--{$key2}-->" value="<!--{$arrForm[$key2]|escape}-->" class="box120 payinput" size="20" placeholder="YAMADA" />
                    </p>
  ...
  <table summary="支払区分" >
      ...
      <tr>
          ...
          <td>
              ...
              <div class="fl30 pdt15">
                <input type="text" name="<!--{$key}-->" value="<!--{$arrForm[$key]|escape}-->" class="w80 payinput" size="4" />
              </div>
              <div class="fl70">
      ...
      <tr id="confirmation_save_card" <!--{if $arrForm.use_card_type == 2}-->style="display:none;"<!--{/if}-->>
          ...
          <td>
              ...
              <span class="attention">※すでに登録済みのカードが存在する場合、先に登録されたカード情報は削除されます。</span>
          </td>
      </tr>
      <!--{else}-->
            ...
            <div class="use_payarea">
                <table summary="決済情報の入力">
                    <tr>
                        ...
                        <td>
                            <span class="attention"><!--{$arrErr.card_no}--></span>
                            <input type="text" name="card_no" value="<!--{$arrForm.card_no|escape}-->" id="gmo_card_no" maxlength="16" class="payinput"/>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="mini">
                                名&nbsp;<input type="text" name="<!--{$key1}-->" value="<!--{$arrForm[$key1]|escape}-->" size="20" class="box120 payinput" placeholder="TARO" />&nbsp;&nbsp;
                                姓&nbsp;<input type="text" name="<!--{$key2}-->" value="<!--{$arrForm[$key2]|escape}-->" size="20" class="box120 payinput" placeholder="YAMADA" /></p>
                              <p class="pdt10">半角入力(例：TARO&nbsp;YAMADA)</p>
                        </td>
                    </tr>
                    <tr>
    ...
    <tr>  
        ...
        <td class="payment_normal" width="300">
            ...
            <div class="custom-select w80">
              <select name="deliv_date" class="w100">
