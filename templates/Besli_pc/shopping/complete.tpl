...
<!--{/if}-->
<!--{if $arrSiteInfo.fanplayr_accesskey}-->
<!-- ▼ Fanplayr -->
...
(function(d, s) {
  if (!window.fp_sales_orders){
    window.fp_sales_orders = {
      ...
      data:{
        orderId:         '<!--{$arrInfo.orderid}-->',
        orderNumber:     '<!--{$arrInfo.orderid}-->',
        orderDate:       '<!--{$arrGAOrder.create_date}-->',
        subTotal:        '<!--{$subtotal1}-->',
        total:           '<!--{$subtotal2}-->',
        discount:        '<!--{if $discount}--><!--{$discount}--><!--{else}-->0<!--{/if}-->',
        discountCode:    '<!--{if $discountCode}--><!--{$discountCode}--><!--{else}-->0<!--{/if}-->',
        currency:        'JPY',
        orderEmail:      '<!--{$arrGAOrder.order_email}-->',
        firstName:       '<!--{$arrGAOrder.order_name02}-->',
        lastName:        '<!--{$arrGAOrder.order_name01}-->',
